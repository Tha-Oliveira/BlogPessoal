...
public class UsuarioController {
	...
	@PostMapping("/logar")
	private ResponseEntity <UsuarioLogin> login(@RequestBody Optional <UsuarioLogin> usuarioLogin)
	{
	...
	private ResponseEntity <Usuario> postUsuario(@Valid @RequestBody Usuario usuario)
	{
